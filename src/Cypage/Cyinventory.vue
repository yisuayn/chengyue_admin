    ...
    <el-row :gutter="12">
      <el-col :span="17">
        <Weight class="Cybox">
          ...
          <el-table
            :data="tableData.filter(data => !search || data.category.toLowerCase().includes(search.toLowerCase()))"
            :fit="true"
          >
            ...
            <el-table-column label="适用季节" prop="Seasonalproperties" align="center"></el-table-column>
            <el-table-column label="适用场景" prop="scenario" align="center"></el-table-column>
            <el-table-column label="尺寸" prop="Sizematrix"></el-table-column>
            <el-table-column label="重量参数" prop="Weightparameters" align="center"></el-table-column>
            <el-table-column label="颜色分类 " prop="Colormanagement" align="center"></el-table-column>
